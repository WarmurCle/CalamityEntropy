...
*/
            layerAssets.Add(ModContent.Request<Texture2D>("CalamityEntropy/Extra/planetarium_blue_base", AssetRequestMode.ImmediateLoad));
            for (int i = 1; i <= 5; i++)
            {
                if (i == 2) continue;
                layerAssets.Add(ModContent.Request<Texture2D>("CalamityEntropy/Extra/planetarium_starfield_" + i.ToString(), AssetRequestMode.ImmediateLoad));
            }
        }
