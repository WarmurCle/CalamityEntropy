...
namespace CalamityEntropy.Common
{
    public class EModSys : ModSystem
    {
        ...
        public void drawChargeBar(Vector2 center, float prog, Color color)
        {
            ...
            Main.spriteBatch.Draw(bar, center, new Rectangle(0, 0, 36, 12), Color.White, 0, new Vector2(18, 6), 2, SpriteEffects.None, 0);
            Main.spriteBatch.Draw(bar, center, new Rectangle(0, 12, (int)Math.Round(36 * prog), 12), color, 0, new Vector2(27, 6), 2, SpriteEffects.None, 0);
        }
