...
namespace CalamityEntropy.Common.DrawLayers
{
    public class TsHoodLayer : PlayerDrawLayer
    {
        ...
        protected override void Draw(ref PlayerDrawSet drawInfo)
        {
            ...
            drawInfo.DrawDataCache.Add(new DrawData(texture, headPos, null, Color.White, drawInfo.drawPlayer.headRotation, new Vector2(texture.Width / 2 - 1 * player.direction, texture.Height / 2 + 9), 1, drawInfo.playerEffect) { shader = drawInfo.drawPlayer.cHead });
        }
    }
}
