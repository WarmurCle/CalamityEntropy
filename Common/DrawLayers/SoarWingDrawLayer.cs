...
namespace CalamityEntropy.Common.DrawLayers
{
    public class SoarWingDrawLayer : PlayerDrawLayer
    {
        ...
        {
            if (drawInfo.shadow != 0f || drawInfo.drawPlayer.dead || (drawInfo.drawPlayer.Entropy().vanityWing != null && !(drawInfo.drawPlayer.Entropy().vanityWing.ModItem is RuneWing)))
                return false;
        ...
        protected override void Draw(ref PlayerDrawSet drawInfo)
        {
            ...
            drawInfo.DrawDataCache.Add(new DrawData(tex, offset, null, drawInfo.colorArmorBody, 0, new Vector2(drawInfo.drawPlayer.direction == 1 ? 59 : tex.Width - 59, 38), 1, drawInfo.drawPlayer.direction == 1 ? SpriteEffects.None : SpriteEffects.FlipHorizontally) { shader = drawInfo.drawPlayer.cWings });
        }
