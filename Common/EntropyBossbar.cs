        ...
        public override void Draw(SpriteBatch spriteBatch, IBigProgressBar currentBar, BigProgressBarInfo info)
        {
            ...
            else
            {
                foreach (NPC n in Main.ActiveNPCs)
                {
                    ...
                    {
                        if (n.realLife < 0 && Util.Util.getDistance(n.Center, Main.LocalPlayer.Center) < 9000)
                        {
                            flag = true;
                            npc = n;
                            break;
            ...
            Texture2D gzmBar = Util.Util.getExtraTex("ColorMapGoozma");
            Texture2D noise = Util.Util.getExtraTex("noise");
