...
namespace CalamityEntropy.NPCs
{
    ...
    {
        private Texture2D closed = ModContent.Request<Texture2D>("CalamityEntropy/NPCs/LM/off").Value;
        private Texture2D openf1 = ModContent.Request<Texture2D>("CalamityEntropy/NPCs/LM/open1").Value;
        private Texture2D openf2 = ModContent.Request<Texture2D>("CalamityEntropy/NPCs/LM/open2").Value;
        private Texture2D openf3 = ModContent.Request<Texture2D>("CalamityEntropy/NPCs/LM/open3").Value;
        private Texture2D opened = ModContent.Request<Texture2D>("CalamityEntropy/NPCs/LM/on").Value;
        private Texture2D warning = ModContent.Request<Texture2D>("CalamityEntropy/NPCs/LM/warn").Value;
        private Texture2D warning2 = ModContent.Request<Texture2D>("CalamityEntropy/NPCs/LM/warn2").Value;
        private Texture2D unhappy = ModContent.Request<Texture2D>("CalamityEntropy/NPCs/LM/unhappy").Value;
        private Texture2D serious = ModContent.Request<Texture2D>("CalamityEntropy/NPCs/LM/serious").Value;
        private Texture2D toMad1 = ModContent.Request<Texture2D>("CalamityEntropy/NPCs/LM/tmad1").Value;
        private Texture2D toMad2 = ModContent.Request<Texture2D>("CalamityEntropy/NPCs/LM/tmad2").Value;
        private Texture2D mad = ModContent.Request<Texture2D>("CalamityEntropy/NPCs/LM/mad").Value;
        private Texture2D madangry = ModContent.Request<Texture2D>("CalamityEntropy/NPCs/LM/angry").Value;
        private Texture2D madtalk = ModContent.Request<Texture2D>("CalamityEntropy/NPCs/LM/mad_talk").Value;
        private Texture2D smile = ModContent.Request<Texture2D>("CalamityEntropy/NPCs/LM/smile").Value;
        private Texture2D flowey = ModContent.Request<Texture2D>("CalamityEntropy/NPCs/LM/flowey").Value;
        private Texture2D think = ModContent.Request<Texture2D>("CalamityEntropy/NPCs/LM/think").Value;
        private Texture2D prepare = ModContent.Request<Texture2D>("CalamityEntropy/NPCs/LM/prepare").Value;
        private Texture2D specialReward = ModContent.Request<Texture2D>("CalamityEntropy/NPCs/LM/sreward").Value;
        private Texture2D what = ModContent.Request<Texture2D>("CalamityEntropy/NPCs/LM/what").Value;
        ...
        public void RightClicked(Player player)
        {
            ...
            {
                open = true;
                SoundEngine.PlaySound(new("CalamityEntropy/Sounds/system_open"), NPC.Center);
            }
            else
            {
                if (openFrame >= 3)
