...
namespace CalamityEntropy.Projectiles
{
    public class OverloadFurnaceHoldout : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D to = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/OverloadFurnaceOutline").Value;
            ...
            Texture2D light = ModContent.Request<Texture2D>("CalamityEntropy/Extra/Glow").Value;
