    ...
    public class VoidStar: ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            if (Projectile.ai[2] == 1)
            {
                ...
                {
                    Util.Util.drawLine(Main.spriteBatch, ModContent.Request<Texture2D>("CalamityEntropy/Extra/white").Value, Projectile.Center, Projectile.Center + Projectile.velocity * 1000, Color.Purple * (0.8f * Projectile.ai[0] / 60f), 2);
                }
            }
            return false;
        }
