    ...
    public class CruiserBlackhole: ModProjectile
    {
        ...
        public override void AI(){
            ...
            if (sp)
            {
                ...
                if (!Main.dedServ)
                {
                    SoundStyle s = new("CalamityEntropy/Sounds/blackholeCharge");
            ...
            if (Projectile.timeLeft < 100)
            {
                ...
                if (scale2 <= 0)
                {
                    ...
                    if (!Main.dedServ)
                    {
                        SoundStyle s = new("CalamityEntropy/Sounds/blackholeEnd");
                        SoundEngine.PlaySound(s, Projectile.Center);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D tx = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Cruiser/Blackhole_p1").Value;
            Texture2D tx2 = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Cruiser/Blackhole_p2").Value;
            Projectile.ai[0] += 6;
