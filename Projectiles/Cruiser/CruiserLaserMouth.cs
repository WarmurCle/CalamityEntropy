...
namespace CalamityEntropy.Projectiles.Cruiser
{
    ...
    public class CruiserLaserMouth: ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D tb = ModContent.Request<Texture2D>("CalamityEntropy/Extra/clback").Value;
            Texture2D px = ModContent.Request<Texture2D>("CalamityEntropy/Extra/white").Value;
            Texture2D tl = ModContent.Request<Texture2D>("CalamityEntropy/Extra/cllight").Value;
            Texture2D tl2 = ModContent.Request<Texture2D>("CalamityEntropy/Extra/cllight2").Value;
            Texture2D th = ModContent.Request<Texture2D>("CalamityEntropy/Extra/clinghth").Value;
