    ...
    public class Rvshoot : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (odp.Count > 1)
            {
                ...
                Texture2D ht = ModContent.Request<Texture2D>("CalamityEntropy/Extra/sth").Value;
                if (!htd)
                {
            ...
            if (odp.Count > 1) {
                ...
                {
                    Texture2D tx = ModContent.Request<Texture2D>("CalamityEntropy/Extra/rvslash").Value;
                    gd.Textures[0] = tx;
                ...
                {
                    c += 1f / odp.Count;
                    Util.Util.drawLine(Main.spriteBatch, ModContent.Request<Texture2D>("CalamityEntropy/Extra/white").Value, odp[i - 1], odp[i], Color.Black, 14 * c, 2);


                    Util.Util.drawLine(Main.spriteBatch, ModContent.Request<Texture2D>("CalamityEntropy/Extra/white").Value, odp[i - 1], odp[i], Color.White , 2 * c, 2);
            ...
            if (exps > 0)
            {
                if (htd)
                {
                    Texture2D tx = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/E_Exp").Value;
