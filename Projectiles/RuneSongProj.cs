    ...
    public class RuneSongProj: ModProjectile
    {
        ...
        public override void AI(){
            ...
            if (Projectile.ai[0] == 83)
            {
                ...
                SoundEngine.PlaySound(new SoundStyle("CalamityEntropy/Sounds/rswave"), Projectile.Center);
                Projectile.damage *= 2;
                odr.Clear();
                ods.Clear();
                if (Projectile.velocity.X > 0)
            ...
            {
                noSlowTime = 4;
                SoundEngine.PlaySound(new SoundStyle("CalamityEntropy/Sounds/sword_spin1"), Projectile.Center);
                odr.Clear();
                ods.Clear();
                if (Projectile.velocity.X > 0)
                {
