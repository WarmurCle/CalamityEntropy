...
namespace CalamityEntropy.Projectiles.HBProj
{
    public class HB : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D part1 = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/HBProj/HB").Value;
            Texture2D eye = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/HBProj/iMark").Value;
