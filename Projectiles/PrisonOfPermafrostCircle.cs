...
namespace CalamityEntropy.Projectiles
{
    public class PrisonOfPermafrostCircle : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            flames.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/POP/flame1").Value);
            flames.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/POP/flame2").Value);
            flames.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/POP/flame3").Value);
            flames.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/POP/flame4").Value);
            Texture2D triangle = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/POP/triangle").Value;
            ...
            Texture2D ice1 = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/POP/ice1").Value;
            Texture2D ice2 = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/POP/ice2").Value;
            Texture2D ice3 = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/POP/ice3").Value;
            ...
            Texture2D c1 = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/POP/c1").Value;
            Texture2D c2 = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/POP/c2").Value;
            Texture2D c3 = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/POP/c3").Value;
            Texture2D c4 = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/POP/c4").Value;
            Texture2D c5 = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/POP/c5").Value;
            Texture2D c6 = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/POP/c6").Value;
            ...
            Texture2D circle = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/POP/circle").Value;
