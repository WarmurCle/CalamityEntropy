...
namespace CalamityEntropy.Projectiles.Chainsaw
{
    public class Euangelion0 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Projectile.Center = player.Center + Projectile.rotation.ToRotationVector2() * 46 * Projectile.scale;
        ...
        public override bool PreDraw(ref Color dc){
            Texture2D tx = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Chainsaw/Euangelion" + (((int)(Projectile.ai[0] / 4)) % frame).ToString()).Value;
            var rand = Main.rand;
