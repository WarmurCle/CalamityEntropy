...
namespace CalamityEntropy.Projectiles.Chainsaw
{
    public class EnslavedStar0 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Projectile.Center = player.Center + Projectile.rotation.ToRotationVector2() * 36 * Projectile.scale + new Vector2(0, -26);
        ...
        public override bool PreDraw(ref Color dc){
            Texture2D tx = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Chainsaw/EnslavedStar" + (((int)(Projectile.ai[0] / 4)) % frame).ToString()).Value;
            var rand = Main.rand;
