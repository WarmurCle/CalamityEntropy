...
namespace CalamityEntropy.Projectiles
{
    public class GhostdomWhisperHoldout : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Util.Util.drawLine(Main.spriteBatch, ModContent.Request<Texture2D>("CalamityEntropy/Extra/white").Value, up, middle, Color.Purple, 2, 2);
            Util.Util.drawLine(Main.spriteBatch, ModContent.Request<Texture2D>("CalamityEntropy/Extra/white").Value, down, middle, Color.Purple, 2, 2);
