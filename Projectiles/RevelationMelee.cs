...
namespace CalamityEntropy.Projectiles
{
    public class RevelationMelee : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            for (int i = 0; i < 9; i++)
            {
                jtx.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/RVM/s" + (i + 1).ToString()).Value);
            }
        }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D tx = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/RevelationMelee").Value;
