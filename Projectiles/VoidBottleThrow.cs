...
*/
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D tx1 = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/VoidBottleThrow").Value;
            Texture2D tx2 = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/VoidBottleThrow1").Value;
            Texture2D tx3 = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/VoidBottleThrow2").Value;
            Texture2D tx = tx1;
