...
namespace CalamityEntropy.Projectiles.VoidEchoProj
{
    public class VoidEchoProj : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D part1 = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/VoidEchoProj/part1").Value;
            Texture2D part2 = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/VoidEchoProj/part2").Value;
            Texture2D eye = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/VoidEchoProj/VoidEye").Value;
            Texture2D sym = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/VoidEchoProj/VoidSymbol").Value;
            Texture2D mark = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/VoidEchoProj/mark").Value;
