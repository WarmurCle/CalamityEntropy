...
using System.Text;
namespace CalamityEntropy.Projectiles.Pets.Signus
{
    public class SigPetProj : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            if (Main.gameMenu)
            {
                Texture2D txd = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Signus/xgns1").Value;
            ...
            list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Signus/xgns1").Value);
            list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Signus/xgns2").Value);
            list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Signus/xgns3").Value);
            list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Signus/xgns4").Value);
