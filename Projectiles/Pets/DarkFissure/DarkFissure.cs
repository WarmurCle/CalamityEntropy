...
namespace CalamityEntropy.Projectiles.Pets.DarkFissure
{
    public class DarkFissure : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (Main.gameMenu) {
                Texture2D txd = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/DarkFissure/DarkFissure").Value;
            ...
            {
                list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/DarkFissure/DarkFissure").Value);
                list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/DarkFissure/DarkFissure2").Value);
                list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/DarkFissure/DarkFissure3").Value);
                list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/DarkFissure/DarkFissure4").Value);
                list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/DarkFissure/DarkFissure5").Value);
                list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/DarkFissure/DarkFissure6").Value);
            }
            else
            {
                list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/DarkFissure/walk1").Value);
                list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/DarkFissure/walk2").Value);
                list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/DarkFissure/walk3").Value);
                list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/DarkFissure/walk4").Value);
                list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/DarkFissure/walk5").Value);
                list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/DarkFissure/walk6").Value);
            }
