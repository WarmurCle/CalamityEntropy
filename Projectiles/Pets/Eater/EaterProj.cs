...
namespace CalamityEntropy.Projectiles.Pets.Eater
{
    public class EaterProj : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (Main.gameMenu) {
                Texture2D txd = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Eater/fly1").Value;
            ...
            {
                list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Eater/fly1").Value);
                list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Eater/fly2").Value);
            }
            else
            {
                list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Eater/walk1").Value);
                list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Eater/walk2").Value);
                list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Eater/walk3").Value);
                list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Eater/walk4").Value);
