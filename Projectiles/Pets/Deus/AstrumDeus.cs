...
using CalamityMod;
namespace CalamityEntropy.Projectiles.Pets.Deus
{
    public class AstrumDeus : ModProjectile
    {
        ...
        {
            if (Main.gameMenu) {
                Texture2D txd = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Deus/AstrumDeus").Value;
            ...
            list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Deus/AstrumDeus").Value);
            list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Deus/AstrumDeus2").Value);
            list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Deus/AstrumDeus3").Value);
            list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Deus/AstrumDeus4").Value);
            list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Deus/AstrumDeus5").Value);
