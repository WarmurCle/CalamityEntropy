...
using System.Text;
namespace CalamityEntropy.Projectiles.Pets.DoG
{
    public class DoG : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            if (Main.gameMenu)
            {
                Texture2D txd = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/DoG/DoG").Value;
            ...
            list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/DoG/DoG").Value);
            list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/DoG/DoG2").Value);
            list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/DoG/DoG3").Value);
            list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/DoG/DoG4").Value);
            list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/DoG/DoG5").Value);
