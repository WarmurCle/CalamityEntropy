...
namespace CalamityEntropy.Projectiles.Pets.Abyss
{
    public class AbyssPet : ModProjectile
    {
        ...
        public Texture2D head = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Abyss/Head").Value;
        public Texture2D body = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Abyss/Body").Value;
        public Texture2D tail = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Abyss/Tail").Value;
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (Main.gameMenu) {
                Texture2D txd = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Abyss/AbyssPet").Value;
            ...
            if (Projectile.ai[1] == 0)
            {
                ...
                {
                    list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Abyss/Afk1").Value);
                    list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Abyss/Afk2").Value);
                    list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Abyss/Afk3").Value);
                }
                else
                {
                    list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Abyss/Walk1").Value);
                    list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Abyss/Walk2").Value);
                    list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Abyss/Walk3").Value);
                    list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Abyss/Walk4").Value);
                }
        ...
        void MoveToTarget(Vector2 targetPos)
        {
            ...
            else
            {
                ...
                if (Util.Util.getDistance(targetPos, Projectile.Center) > 400) {
                    Projectile.ai[1] = 1;
                }
