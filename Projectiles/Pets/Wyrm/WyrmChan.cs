...
namespace CalamityEntropy.Projectiles.Pets.Wyrm
{
    public class WyrmChan : ModProjectile
    {
        ...
        {
            if (Main.gameMenu) {
                Texture2D txd = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Wyrm/WyrmChan").Value;
            ...
            list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Wyrm/WyrmChan").Value);
            list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Wyrm/WyrmChan2").Value);
            list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Wyrm/WyrmChan3").Value);
            list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Wyrm/WyrmChan4").Value);
            List<Texture2D> list2 = new List<Texture2D>();
            list2.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Wyrm/Eye").Value);
            list2.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Wyrm/Eye2").Value);
            list2.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Wyrm/Eye3").Value);
            list2.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/Wyrm/Eye4").Value);
