...
namespace CalamityEntropy.Projectiles.Pets.StormWeaver
{
    public class StormWeaverPet : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (Main.gameMenu) {
                Texture2D txd = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/StormWeaver/flight1").Value;
            ...
            {
                list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/StormWeaver/flight1").Value);
                list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/StormWeaver/flight2").Value);
                list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/StormWeaver/flight3").Value);
                list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/StormWeaver/flight4").Value);
                list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/StormWeaver/flight5").Value);
                list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/StormWeaver/flight6").Value);
            }
            else
            {
                list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/StormWeaver/walk1").Value);
                list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/StormWeaver/walk2").Value);
                list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/StormWeaver/walk3").Value);
                list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/StormWeaver/walk4").Value);
                list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/StormWeaver/walk5").Value);
                list.Add(ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/Pets/StormWeaver/walk6").Value);
