...
namespace CalamityEntropy.Projectiles.monument
{
    ...
    {
        SoundStyle hitSound = new("CalamityEntropy/Sounds/vb_hit");
        SoundStyle hs = new("CalamityEntropy/Sounds/vbuse");
        ...
        public override bool PreDraw(ref Color dc){
            Texture2D tx = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/monument/f" + ((int)Projectile.ai[1] + 1).ToString()).Value;
