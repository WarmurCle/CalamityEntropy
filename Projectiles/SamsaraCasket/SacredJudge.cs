...
namespace CalamityEntropy.Projectiles.SamsaraCasket
{
    public class SacredJudge : SamsaraSword
    {
        ...
        public override void AI()
        {
            ...
            {
                SoundEngine.PlaySound(new SoundStyle("CalamityEntropy/Sounds/DeadSunShot"), player.Center);
            }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D phantom = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/SamsaraCasket/SacredJudgePhantom").Value;
            ...
            if (phantom0 > 0)
            {
                if(phantom0 < 9)
                {
                    phantom = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/SamsaraCasket/SacredJudgePhantom0").Value;
                }
                if (phantom0 < 5)
                {
                    phantom = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/SamsaraCasket/SacredJudgePhantom1").Value;
                }
            ...
            phantom = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/SamsaraCasket/SacredJudgePhantom").Value;
            if (phantom1 > 0)
            {
                if (phantom1 < 9)
                {
            ...
            if (modPlayer.SacredJudgeShields > 0)
            {
                Texture2D shield = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/SamsaraCasket/SacredJudgeShield").Value;
