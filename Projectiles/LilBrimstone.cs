...
namespace CalamityEntropy.Projectiles
{
    public class LilBrimstone : ModProjectile
    {
                ...
                if (Projectile.ai[2] <= 0)
                {
                    ...
                    if (Projectile.ai[0] > 10)
                    {
                        ...
                        if (Projectile.ai[1] == 7)
                        {
                            ...
                            SoundEngine.PlaySound(new SoundStyle("CalamityEntropy/Sounds/blood laser weak 1"), Projectile.Center);
                        }
                    }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D tx;
            tx = ModContent.Request<Texture2D>("CalamityEntropy/Projectiles/LilBrimstone").Value;
