...
namespace CalamityEntropy.Items.Vanity
{
    public class GalaxyGrapeSoda : ModItem
    {
        public override void Load()
        {
            ...
            {
                EquipLoader.AddEquipTexture(Mod, "CalamityEntropy/Items/Vanity/ggs_Head", EquipType.Head, this);
                EquipLoader.AddEquipTexture(Mod, "CalamityEntropy/Items/Vanity/ggs_Body", EquipType.Body, this);
                EquipLoader.AddEquipTexture(Mod, "CalamityEntropy/Items/Vanity/ggs_Legs", EquipType.Legs, this);
            }
        }
