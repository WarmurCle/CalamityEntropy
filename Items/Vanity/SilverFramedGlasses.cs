...
namespace CalamityEntropy.Items.Vanity
{
    public class SilverFramedGlasses : ModItem
    {
        public override void Load()
        {
            ...
            {
                EquipLoader.AddEquipTexture(Mod, "CalamityEntropy/Items/Vanity/dm_Head", EquipType.Head, this);
                EquipLoader.AddEquipTexture(Mod, "CalamityEntropy/Items/Vanity/dm_Body", EquipType.Body, this);
                EquipLoader.AddEquipTexture(Mod, "CalamityEntropy/Items/Vanity/dm_Legs", EquipType.Legs, this);
            }
        }
