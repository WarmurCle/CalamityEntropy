    ...
    public class CrossBorderPursuitProj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (counter < MaxTime)
            {
                ...
                {
                    if (counter % 9 == 0)
                        EParticle.NewParticle(new Particles.PrismShardParticle() { PixelShader = true }, target.Center + CEUtils.randomPointInCircle(128), Vector2.Zero, Color.White, 1, 1, true, BlendState.AlphaBlend, CEUtils.randomRot());
