                ...
                case Mode.Shooting:
                    {
                        ...
                        if (target != null && Projectile.owner == Main.myPlayer)
                        {
                            ...
                            {
                                Delay = 40;
                                Projectile.NewProjectile(Projectile.GetSource_FromAI(), Projectile.Center, (target.Center - Projectile.Center).normalize() * 36, ModContent.ProjectileType<CarverBolt>(), Projectile.damage * 10, 4, Projectile.owner).ToProj().scale *= 0.7f;
