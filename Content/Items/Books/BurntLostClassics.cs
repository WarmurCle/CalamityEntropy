...
namespace CalamityEntropy.Content.Items.Books
{
    ...
    public class BurntBrimShot : EBookBaseProjectile
    {
        ...
        public override void AI()
        {
            ...
            for(int i = 0; i < 4; i++)
            {
                EParticle.spawnNew(new Smoke() { timeleftmax = 26, timeLeft = 26 }, Projectile.Center, Util.randomPointInCircle(0.5f), Color.OrangeRed, Main.rand.NextFloat(0.02f, 0.04f), 0.5f, true, BlendState.Additive, Util.randomRot());
            }
