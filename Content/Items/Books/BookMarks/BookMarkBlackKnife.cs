...
namespace CalamityEntropy.Content.Items.Books.BookMarks
{
    ...
    public class BlackKnifeBMEffect : EBookProjectileEffect
    {
        public override void OnHitNPC(Projectile projectile, NPC target, int damageDone)
        {
            ...
            {
                Projectile.NewProjectile(projectile.GetSource_FromAI(), target.Center, Vector2.Zero, ModContent.ProjectileType<BlackKnife>(), (int)(damageDone * 1.16f), projectile.knockBack, projectile.owner, target.whoAmI, CEUtils.randomRot());
            }
        }
    }
}
