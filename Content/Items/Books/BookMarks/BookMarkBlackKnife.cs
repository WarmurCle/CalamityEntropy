...
namespace CalamityEntropy.Content.Items.Books.BookMarks
{
    ...
    public class BlackKnifeBMEffect : EBookProjectileEffect
    {
        public override void OnHitNPC(Projectile projectile, NPC target, int damageDone)
        {
            ...
            {
                Projectile.NewProjectile(projectile.GetSource_FromThis(), target.Center, Vector2.Zero, ModContent.ProjectileType<BlackKnife>(), damageDone, projectile.knockBack, projectile.owner, target.whoAmI, CEUtils.randomRot());
            }
        }
    }
}