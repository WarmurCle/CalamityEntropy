    ...
    public class LotteryMachine : ModNPC
    {
        ...
        public override void AI()
        {
            if (sd)
            {
                ...
                s1 = new RewardPool();
                s1.Add(new RewardPoolItem(ModContent.ItemType<WulfrumMetalScrap>(), 10)); s1.Add(new RewardPoolItem(ItemID.Feather, 5));
                ...
                s1.Add(new RewardPoolItem(ItemID.Diamond, 2));
                ...
                s1.Add(new RewardPoolItem(ItemID.Ruby, 4));
                ...
                g1.Add(new RewardPoolItem(ItemID.LifeCrystal, 1)); 
                ...
                g1.Add(new RewardPoolItem(ModContent.ItemType<AncientBoneDust>(), 1)); s1.Add(new RewardPoolItem(ItemID.PoopBlock, 50));
                ...
                g1.Add(new RewardPoolItem(ItemID.LifeCrystal, 2));
                ...
                g2.Add(new RewardPoolItem(ModContent.ItemType<SolarVeil>(), 30));
                g2.Add(new RewardPoolItem(ModContent.ItemType<DepthCells>(), 1));
                g2.Add(new RewardPoolItem(1508, 3));
                g2.Add(new RewardPoolItem(391, 15));
                g2.Add(new RewardPoolItem(1198, 15));
                g2.Add(new RewardPoolItem(ModContent.ItemType<CryonicBar>(), 1));
                ...
                p2.Add(new RewardPoolItem(ModContent.ItemType<MeldBlob>(), 3));
                p2.Add(new RewardPoolItem(ModContent.ItemType<PlagueCellCanister>(), 1));
                ...
                p2.Add(new RewardPoolItem(ModContent.ItemType<YharimsStimulants>(), 10));
                p2.Add(new RewardPoolItem(ModContent.ItemType<TheCamper>(), 1));
                p2.Add(new RewardPoolItem(ModContent.ItemType<HadarianWings>(), 1));
                p2.Add(new RewardPoolItem(ModContent.ItemType<FabsolsVodka>(), 10));
                ...
                p3.Add(new RewardPoolItem(ModContent.ItemType<Bloodstone>(), 1));
                p3.Add(new RewardPoolItem(ModContent.ItemType<TheStorm>(), 1));
                p3.Add(new RewardPoolItem(ModContent.ItemType<GalacticaSingularity>(), 10));
