    ...
    public class LotteryMachine : ModNPC
    {
        ...
        public override void AI()
        {
            if (sd)
            {
                ...
                s1.Add(new RewardPoolItem(ModContent.ItemType<MurkyPaste>(), 4));s1.Add(new RewardPoolItem(ItemID.cloud, 20));
                ...
                s1.Add(new RewardPoolItem(ModContent.ItemType<BloodOrb>(), 20)); s1.Add(new RewardPoolItem(ItemID.Diamond, 1));
                s1.Add(new RewardPoolItem(68, 8)); s1.Add(new RewardPoolItem(ModContent.ItemType<MurkyPaste>(), 10));
                s1.Add(new RewardPoolItem(ModContent.ItemType<AncientBoneDust>(), 2)); s1.Add(new RewardPoolItem(ItemID.PoopBlock, 20));
                ...
                g1 = new RewardPool();
                g1.Add(new RewardPoolItem(ModContent.ItemType<SeaPrism>(), 10)); g1.Add(new RewardPoolItem(ModContent.ItemType<>(BlackLens), 2));
                ...
                g1.Add(new RewardPoolItem(ModContent.ItemType<TrapperBulb>(), 2)); g1.Add(new RewardPoolItem(ModContent.ItemType<BoundingPotion>(), 3));
                g1.Add(new RewardPoolItem(ItemID.LifeCrystal, 4)); g1.Add(new RewardPoolItem(ItemID.MeteoriteBar, 2));
                ...
                g1.Add(new RewardPoolItem(ItemID.Ruby, 20));
                g1.Add(new RewardPoolItem(ItemID.FallenStar, 20));

                p1 = new RewardPool();
                p1.Add(new RewardPoolItem(2341, 1));g1.Add(new RewardPoolItem(ModContent.ItemType<VoltaicJelly>(), 1));
                p1.Add(new RewardPoolItem(906, 1)); p1.Add(new RewardPoolItem(ModContent.ItemType<AbyssalAmulet>(), 1));
                p1.Add(new RewardPoolItem(ItemID.GoldenKey, 3)); p1.Add(new RewardPoolItem(ItemID.FlinxFur, 1));
                p1.Add(new RewardPoolItem(ModContent.ItemType<OldLordClaymore>(), 1)); p1.Add(new RewardPoolItem(2296, 1));
                p1.Add(new RewardPoolItem(ItemID.FallenStar, 100)); p1.Add(new RewardPoolItem(ModContent.ItemType<AeroStone>(), 1));
                p1.Add(new RewardPoolItem(2430, 1));g1.Add(new RewardPoolItem(ItemID.BloodRainBow, 1));
                ...
                p1.Add(new RewardPoolItem(ModContent.ItemType<>(DragoonDrizzlefish), 1));
                p1.Add(new RewardPoolItem(ModContent.ItemType<>(RustyBeaconPrototype), 1));
                p1.Add(new RewardPoolItem(ItemID.LifeCrystal, 4));
                ...
                g2.Add(new RewardPoolItem(ModContent.ItemType<MolluskHusk>(), 30));
                g2.Add(new RewardPoolItem(ItemID.FrostCore, 5));
                g2.Add(new RewardPoolItem(ModContent.ItemType<SolarVeil>(), 10));
                g2.Add(new RewardPoolItem(ModContent.ItemType<CorrodedFossil>(), 3));
                g2.Add(new RewardPoolItem(ModContent.ItemType<MidasPrime>(), 1));
                g2.Add(new RewardPoolItem(1508, 3));
                g2.Add(new RewardPoolItem(391, 15));
                g2.Add(new RewardPoolItem(1198, 15));
                g2.Add(new RewardPoolItem(ModContent.ItemType<CryonicOre>(), 10));
                g2.Add(new RewardPoolItem(1612, 1));
                g2.Add(new RewardPoolItem(ModContent.ItemType<GrandGelatin>(), 1));
                g2.Add(new RewardPoolItem(ModContent.ItemType<MomentumCapacitor>(), 1));
                g2.Add(new RewardPoolItem(ModContent.ItemType<SerpentsBite>(), 1));
                ...
                p2.Add(new RewardPoolItem(ModContent.ItemType<CorrosiveSpine>(), 1));
                p2.Add(new RewardPoolItem(ModContent.ItemType<EffulgentFeather>(), 3));
                p2.Add(new RewardPoolItem(ModContent.ItemType<NuclearFuelRod>(), 1));
                ...
                p2.Add(new RewardPoolItem(ModContent.ItemType<VoidofCalamity>(), 1));
                p2.Add(new RewardPoolItem(ModContent.ItemType<FleshTotem>(), 1));
                p2.Add(new RewardPoolItem(ItemID.AnkhCharm, 2));
                p2.Add(new RewardPoolItem(ModContent.ItemType<YharimsStimulants>(), 26));
                p2.Add(new RewardPoolItem(ModContent.ItemType<TheCamper>(), 1));
                p2.Add(new RewardPoolItem(ModContent.ItemType<GloveofPrecision>(), 1));
                ...
                p3.Add(new RewardPoolItem(ModContent.ItemType<Abyssal Diving Suit>(), 1));
                ...
                p3.Add(new RewardPoolItem(ModContent.ItemType<BurningRevelation>(), 1));
                p3.Add(new RewardPoolItem(ModContent.ItemType<BlissfulBombardier>(), 1));
                ...
                p4.Add(new RewardPoolItem(ModContent.ItemType<Sacifice>(), 1));
