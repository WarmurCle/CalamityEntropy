...
namespace CalamityEntropy.Content.Projectiles
{
    public class OverloadLunarHoldout : ModProjectile
    {
        ...
        public override void AI(){
            ...
            {
                if (owner.CheckMana(Main.rand.Next(1, 3), true))
                {
                    ...
                    if (!Main.dedServ)
                    {
                        Util.Util.PlaySound("soulshine", Main.rand.NextFloat(0.8f, 1.2f), Projectile.Center, 8, 0.14f);
                    }
            ...
            Projectile.Center = owner.MountedCenter + player.gfxOffY * Vector2.UnitY + Projectile.velocity.SafeNormalize(Vector2.Zero) * 16;
