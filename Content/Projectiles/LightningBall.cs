    ...
    public class LightningBall : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (Main.myPlayer == Projectile.owner)
            {
                ...
                {
                    Projectile.NewProjectile(projectile.GetSource_FromAI(), projectile.Center, new Vector2(30, 0).RotatedBy(Main.rand.NextDouble() * Math.PI * 2), ModContent.ProjectileType<Lightning>(), (int)(projectile.damage * 0.2f), 4, projectile.owner, 0, 0, Projectile.ai[1]).ToProj().DamageType = DamageClass.Magic;
                }
            }
