...
namespace CalamityEntropy.Content.Projectiles
{
    public class RuneBullet : EBookBaseProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                EParticle.NewParticle(new GlowSpark(), Projectile.Center, Utilities.Util.randomRot().ToRotationVector2() * Main.rand.NextFloat(2, 7), Color.LightBlue, Main.rand.NextFloat(0.06f, 0.1f), 1, true, BlendState.Additive, 0);
            }
        }
        ...
        public void drawT()
        {
            ...
            if (odp.Count > 1)
            {
                ...
                Utilities.Util.DrawGlow(position + Main.screenPosition, Color.Lerp(Color.White, baseColor * 1.1f, (float)(Math.Cos(Main.GlobalTimeWrappedHourly) * 0.5 + 0.5)), Projectile.scale * 0.6f);
