    ...
    public class Asleep : SamsaraSword
    {
        ...
        public override void attackAI(NPC t)
        {
            ...
            if (counter >= 60)
            {
                ...
                Projectile.rotation = Utilities.Util.rotatedToAngle(Projectile.rotation, (t.Center - Projectile.Center).ToRotation(), 0.2f, false);

            }
            else
            {
                Projectile.rotation = Utilities.Util.rotatedToAngle(Projectile.rotation, Projectile.velocity.ToRotation(), 0.4f, false);
            }
