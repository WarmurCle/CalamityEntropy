    ...
    public class WuppoPet : ModProjectile
    {
        ...
        void MoveToTarget(Vector2 targetPos)
        {
            ...
            else
            {
                ...
                if (Math.Abs(Projectile.velocity.X) > 0.3f && !Utilities.Util.isAir(Projectile.Center + (Projectile.velocity * new Vector2(1, 0)).SafeNormalize(Vector2.Zero) * 14 + new Vector2(0, 13)))
                {
