...
namespace CalamityEntropy.Content.Projectiles
{
    ...
    public class ZyphrosCrystal : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[1] > -20)
            {
                Projectile.velocity = ((player.Center + ((Projectile.Center - player.Center).ToRotation() + 0.2f * rotdir).ToRotationVector2() * 110) - Projectile.Center).SafeNormalize(Vector2.Zero) * (Util.Util.getDistance(Projectile.Center, player.Center) > 150 ? 12 : 4);
            }
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            if(Projectile.ai[0] == 1)
            {
                ...
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<ZyphrosCrystal>(), Projectile.damage, Projectile.knockBack, Projectile.owner, Main.rand.Next(2, 6));
            }
        }
    }
