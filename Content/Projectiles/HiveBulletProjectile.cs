...
namespace CalamityEntropy.Content.Projectiles
{
    public class HiveBulletProjectile : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            {
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Util.Util.randomRot().ToRotationVector2() * Main.rand.NextFloat(10, 15), ModContent.ProjectileType<SmallBee>(), damageDone / 4, Projectile.knockBack / 2, Projectile.owner);
            }
        }
